...
#Invierte columna 
#Argumentos
#$a0 <- Dir de matriz  (base)
#$a1 <- nFilas
#$a2 <- nCols
#$a3 <- columna a invertir (hay que restarle 1)
...
InvCol:
  ...
  #dif = ncols * size  //Diferencia entre una casilla y la que esta debajo 
  mul $t1,$a2,$t0

  #first = col * size + base  //Primer elemento de la columna 
  mul $t2,$a3,$t0
  add $t2,$t2,$a0

  
  #last = dif * (nrows-1) + first  // Ultimo elemento de la columna 
  move $t3,$a1
  addi $t3,-1
  mul $t3,$t3,$t1
  add $t3,$t3,$t2
