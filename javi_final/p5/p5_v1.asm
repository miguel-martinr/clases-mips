...
# e indica si es palindroma.
#
#
# Autor: Miguel Martin
# e-mail: alu0101209777@ull.edu.es
# Fecha creacion: 20200510

.data
cadena:   	.asciiz "Practica 5 de Principios de Computadores. Quedate en casa!!\n\nPrograma que pide una cadena por teclado, la invierte (recursiva  e iterativamente) e indica si es palindroma.\n"
...
# INTRODUCE AQUi EL CoDIGO DE LA FUNCIoN reverse_r SIN CAMBIAR LOS ARGUMENTOS
  ...
  li $v0,1                      #Partimos de que es palindroma

  move $t1,$a0
  add $t1,$t1,$a1
  addi $t1,-1                   #$t1 = dir de ultimo caracter
...
print:
#Funcion que imprime la cadena y cuantos caracteres tiene
#$a0 Posicion donde empieza la cadena
#$a1 Nº de caracteres
  li $v0,4
  syscall
...
move $a0,$s0
jal strlen
move $s1,$v0                    #Guardamos el tamanio de la cadena

                                #Quitamos el salto de linea que aniade la syscall al leer de teclado
move $t0,$s0
